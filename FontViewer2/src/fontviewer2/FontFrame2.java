...
public class FontFrame2 extends JFrame {
  ...
  */
    ...
    public JMenu createStyleMenu()
    {
        ...
        menu.add(createStyleItem("Italic Bold", Font.BOLD + Font.ITALIC));
        menu.add(createStyleItem("Roman BaseLine",Font.ROMAN_BASELINE));
        return menu;
    }
    /**
     * Creates a menu item to change the font face and set the action listener.
    ...
    /**
     * Creates a menu item to change the font size and set it's action
     * listener.
     * @param name the name of the menu item. 
     * @param increment the amount by which you want to change the size.
     * @return the menu item.
     */
    ...
    /**
     * Creates a menu item to change the font style and set it's action
     * listener.
     * @param name the name of the menu item.
